...
function Hero() {
    ...
    return (
        <div className="" style={{ backgroundImage: "url('/assets/profile-min.jpg')", backgroundSize: 'cover', backgroundPosition: '0px -150px', backgroundRepeat: 'no-repeat' }}>
            <div className="w-full h-full bg-black/65 flex flex-col items-center py-16 md:py-20">
                <div className="mt-30 w-11/12 md:w-15/20 flex flex-col md:items-start items-center text-center md:text-left">
                    <p className="text-2xl font-bold md:text-4xl text-white">{t('About Us')}</p>
                    <p className="text-2xl font-bold md:text-5xl mt-8 md:mt-15 text-white">{t('Company Profile')}</p>
                    <div>
