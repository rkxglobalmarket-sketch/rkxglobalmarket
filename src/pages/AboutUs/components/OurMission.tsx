        ...
        <div className="w-full flex flex-col items-center justify-center bg-[#F7F7F7]">
            <div className="w-full md:w-15/20 flex flex-col items-center justify-center px-4 md:px-0">
                ...
                <p className="font-bold text-center text-md md:text-xl mt-6 md:mt-10">
                    {t("INTRAGLOBAL LIMITED was founded in 2016 by a team of talented IT and FinTech specialists who wanted to prove that people don’t need to compromise to earn on financial markets — that trading should be accessible, convenient and more fun.")}
                </p>
            ...
            <div className="flex flex-wrap items-center justify-center mt-10 gap-10 mb-10">
                <OurMissionCard content={t("INTRAGLOBAL LIMITED's mission is to provide its clients with the best spread and variety of financial trading products in the market, while providing unmatched turnover rates and the strongest solvency through the world's most technologically advanced order trading platform.")} />
