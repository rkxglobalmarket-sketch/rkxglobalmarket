...
function ContactInfo() {
    ...
    return (
        <div className="flex flex-wrap justify-center w-full bg-[#FCFCFC]">
            ...
            <div className="bg-white border-2 border-white shadow-md py-10 px-30 m-20 hover:shadow-2xl hover:border-2 hover:border-gray-500 mb-10 transition-all duration-300 ease-in-out">
                <h1 className="text-3xl font-bold text-center">
                    {t("Contact us")}
                </h1>
                <p className="mt-5 text-gray-600 text-center">
                    {t("customer@intragloballimited.com")}
                </p>
            </div>
        </div>
    )
