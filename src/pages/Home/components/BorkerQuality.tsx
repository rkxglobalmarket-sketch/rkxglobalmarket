    ...
    return (
        <div className="flex flex-col w-full justify-center items-center mt-20">
            ...
            <div className="flex flex-wrap justify-center gap-4 w-full max-w-5xl mx-auto px-4 pt-12 md:w-14/20 md:pl-12">
                <BrokerCard image={<img src="/assets/strictly-regulated-broker-min.png" alt="Image 1" className = "max-h-[130px] max-w-[160px]"/>} title={t("A highly regulated broker")} content={t("INTRAGLOBAL LIMITED headquartered in the United States is qualified for financial services and regulated by financial institutions MSB in the United States.")}/>
