    ...
    return (
        <div className="relative">
            ...
            <div className="w-11/12 mt-18 max-w-5xl text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-around gap-8 md:gap-8 px-4 md:px-0">
                ...
                />
                <SplitText
                    text={t("Every quarter, INTRAGLOBAL LIMITED strategically cooperates with world-class accounting firms to audit the firm's trading volume and clients' real-time financial assets")}
