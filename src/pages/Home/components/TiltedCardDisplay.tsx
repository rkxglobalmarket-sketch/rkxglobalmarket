...
function TiltedCardDisplay() {
    ...
    return (
        <div className='mt-20 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] max-w-[950px] w-full px-4 sm:px-6'>
            ...
            <p className='text-sm text-center mb-4'>{t("We offer INTRAGLOBAL LIMITED, one of the world's most recognized and widely used online trading platforms. INTRAGLOBAL LIMITED provides powerful chart analysis tools:")}</p>
