    ...
    return (
        <div className="bg-white rounded-xl border p-6 w-full max-w-5xl mx-auto shadow-md mt-20">
            ...
            <div className="text-center text-sm text-blue-600 mt-4">
                <a href="https://www.finlogix.com/?utm_source=https://www.intraglobalfx.com/&utm_medium=widget&utm_campaign=SymbolList&utm_term=hyperlink" className="underline hover:text-blue-800">
