    ...
    return (
        <div className="bg-[#F8F8F8] py-10">
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-10">
                ...
                <ProductCard image="/assets/Mask-Group-2.png" title={t('Without any commission')} content={t('INTRAGLOBAL LIMITED\'s trading fees on foreign-exchange products are simply the point spread between the bid-ask spread')} />
