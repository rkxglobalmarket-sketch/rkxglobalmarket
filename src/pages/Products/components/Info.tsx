...
function Info() {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <p className="text-center text-4xl font-bold p-5 pt-10 w-3/4 text-[#023A51]">
                {t("Start trading with INTRAGLOBAL LIMITED with a few simple steps")}
            </p>
            <div className="flex flex-wrap gap-20">
                <img src="/public/assets/Group-2-1.png" alt="" />
