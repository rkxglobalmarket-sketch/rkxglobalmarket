        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-80">
            ...
            <div className="flex flex-col justify-center items-center">
              <a href="https://t.me/Intragloballimited09" className="text-blue-600 w-full text-center">Intragloballimited09</a>
              <a href="https://t.me/Intragloballimited06" className="text-blue-600 w-full text-center">Intragloballimited06</a>
            </div>
            <button
